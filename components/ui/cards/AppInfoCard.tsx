...
export interface AppInfoCardProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'title'> {
    ...
    icon?: React.ComponentType<{ size?: number; className?: string }> | React.ReactNode | null;
    showIcon?: boolean;
}

const defaultIcons: Record<AppInfoCardVariant, React.ComponentType<{ size?: number; className?: string }>> = {
    info: Info,
