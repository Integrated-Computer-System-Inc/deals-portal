...
const DEMO_ROLES: DemoRoleOption[] = [
  {
    ...
    description: 'Unrestricted access across all 8,426+ deals, all BUs, status updates, WTN alerts, and CSV export.',
    scope: 'All BUs & AOs • Full Read/Write • Export Enabled',
